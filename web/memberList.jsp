...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    align-items: center;
       ...
       .card img {
    width: 100%;         /* Đảm bảo ảnh rộng bằng card */
    height: 200px;       /* Chiều cao cố định của ảnh */
    object-fit: cover;   /* Cắt ảnh nếu không cùng tỷ lệ để vừa khung */
    border: 3px solid #FF69B4;
/* Thêm viền cho ảnh */
    border-radius: 5px;  /* Bo góc ảnh cho đẹp */
}
.card {
    border: 3px solid #808080;  /* Viền cho card */
    border-radius: 5px;      /* Bo góc card */
    overflow: hidden;        /* Cắt phần thừa nếu có */
    box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); /* Đổ bóng nhẹ cho card */
...
.card-body img {
    width: 100%;       /* Chiều rộng ảnh bằng chiều rộng của card */
    height: 200px;     /* Chiều cao cố định cho ảnh */
    object-fit: cover; /* Cắt ảnh vừa với khung mà không bị méo */
    border-bottom: 1px solid #ddd; /* Viền ngăn cách giữa ảnh và phần nội dung */
}
...
.form-select {
    ...
    transform: translateX(-30px); /* Dịch sang trái 10px */
                                ...
                                <div class="col-md-3">
                                    <div class="card mb-3 shadow-sm">
                                        <div class="card-body text-center">
                                            <img src="${member.imageURL}" alt="Avatar"  class="card-img-top">
