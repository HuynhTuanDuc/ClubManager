    ...
    <i class="fas fa-times"></i>
            ...
            <div class="pagination">
                <c:if test="${currentPage > 1}">
                    <a href="listEvent?page=${currentPage - 1}">&laquo; Prev</a>
                </c:if>
                <c:forEach begin="1" end="${totalPages}" var="i">
                    <a href="listEvent?page=${i}" class="${i == currentPage ? 'active' : ''}">${i}</a>
                </c:forEach>
                <c:if test="${currentPage < totalPages}">
                    <a href="listEvent?page=${currentPage + 1}">Next &raquo;</a>
                </c:if>
            </div>
        </div>
    </body>
